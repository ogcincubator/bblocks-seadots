...
# POSEIDON Regulation and Policy Input (Schema)

`ogc.hosted.seadots.poseidon-input-regulation-policy` *v0.1*

Schema for regulation, policy, closure, quota, trigger, shock, and intervention inputs consumed by POSEIDON.
...
```jsonld
{
  "@context": "https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-regulation-policy/context.jsonld",
  "regulations": [
    {
      "type": "Seasonal Closure",
      "startDay": 120,
...
[] schema:legislation ( [ schema:about ( "Species 0" ) ;
                :actions [ :forbidFishing true ] ;
                :conditions [ :betweenYearlyDates true ] ;
                :endDay 200 ;
                :startDay 120 ;
                :type "Seasonal Closure" ] ) .
...
title: POSEIDON Regulation and Policy Input
description: Management-policy and regulation input applied to POSEIDON scenarios.
type: object
properties:
  regulations:
    type: array
    items:
      ...
      properties:
        ...
        actions:
          ...
          additionalProperties: true
      additionalProperties: true
    x-jsonld-id: https://schema.org/legislation
    x-jsonld-container: '@list'
  shocks:
    type: array
    description: Time-varying interventions or exogenous changes applied during a
      run.
    items:
      type: object
      additionalProperties: true
    x-jsonld-id: https://schema.org/event
    x-jsonld-container: '@list'
additionalProperties: true
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-regulation-policy/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-regulation-policy/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-regulation-policy/context.jsonld)

## Sources

* [POSEIDON regulations module](https://github.com/poseidon-fisheries/POSEIDON/tree/main/regulations)
...
* Path: `_sources/_stage/poseidon-input-regulation-policy`
