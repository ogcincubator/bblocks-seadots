...
indp:TAC_herring_share_sv a ssn:Property, skos:Concept ;
    rdfs:label "Swedish share of herring TAC"@en ;
    skos:prefLabel "Swedish share of herring TAC"@en ;
    skos:altLabel "TAC_herring_share_sv"@en ;
    skos:notation "TAC_herring_share_sv" ;
    skos:definition "Fractional share of the total herring TAC allocated to the Swedish (SV) fleet."@en ;
...
indo:fuel_consumption_SV a sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Fuel consumption, Swedish fleet"@en ;
    skos:prefLabel "Fuel consumption, Swedish fleet"@en ;
    skos:altLabel "fuel_consumption_SV"@en ;
    skos:notation "fuel_consumption_SV" ;
    skos:definition "Total marine fuel consumed by the Swedish (SV) fishing fleet during the reporting tick."@en ;
    skos:broader indo:fleet-fuel-consumption ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Volume .

indo:fuel_consumption_LV a sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Fuel consumption, Latvian fleet"@en ;
    skos:prefLabel "Fuel consumption, Latvian fleet"@en ;
    skos:altLabel "fuel_consumption_LV"@en ;
    skos:notation "fuel_consumption_LV" ;
    skos:definition "Total marine fuel consumed by the Latvian (LV) fishing fleet during the reporting tick."@en ;
    skos:broader indo:fleet-fuel-consumption ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Volume .
...
indo:landing_value_herring_SV a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Herring landing value, Swedish fleet"@en ;
    skos:prefLabel "Herring landing value, Swedish fleet"@en ;
    skos:altLabel "landing_value_herring_SV"@en ;
    skos:notation "landing_value_herring_SV" ;
    skos:definition "Monetary value of herring landings by the Swedish (SV) fleet during the reporting tick."@en ;
    skos:broader indo:fish-landing-value ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .

indo:landing_value_herring_LV a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Herring landing value, Latvian fleet"@en ;
    skos:prefLabel "Herring landing value, Latvian fleet"@en ;
    skos:altLabel "landing_value_herring_LV"@en ;
    skos:notation "landing_value_herring_LV" ;
    skos:definition "Monetary value of herring landings by the Latvian (LV) fleet during the reporting tick."@en ;
    skos:broader indo:fish-landing-value ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .

indo:landing_value_sprat_SV a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Sprat landing value, Swedish fleet"@en ;
    skos:prefLabel "Sprat landing value, Swedish fleet"@en ;
    skos:altLabel "landing_value_sprat_SV"@en ;
    skos:notation "landing_value_sprat_SV" ;
    skos:definition "Monetary value of sprat landings by the Swedish (SV) fleet during the reporting tick."@en ;
    skos:broader indo:fish-landing-value ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .

indo:landing_value_sprat_LV a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Sprat landing value, Latvian fleet"@en ;
    skos:prefLabel "Sprat landing value, Latvian fleet"@en ;
    ...
    skos:definition "Monetary value of sprat landings by the Latvian (LV) fleet during the reporting tick. NOTE: the original NetLogo identifier uses a hyphen ('landing-value_sprat_LV') rather than an underscore; both spellings are kept as notations / altLabels for lookup."@en ;
    skos:broader indo:fish-landing-value ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .

indo:catch_herring_SV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Total herring catch, Swedish fleet (all vessels)"@en ;
    skos:prefLabel "Total herring catch, Swedish fleet (all vessels)"@en ;
    skos:altLabel "catch_herring_SV_All"@en ;
    skos:notation "catch_herring_SV_All" ;
    skos:definition "Total mass of herring caught by all Swedish (SV) vessels during the reporting tick."@en ;
    skos:broader indo:fish-catch ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Mass .

indo:catch_herring_LV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Total herring catch, Latvian fleet (all vessels)"@en ;
    skos:prefLabel "Total herring catch, Latvian fleet (all vessels)"@en ;
    skos:altLabel "catch_herring_LV_All"@en ;
    skos:notation "catch_herring_LV_All" ;
    skos:definition "Total mass of herring caught by all Latvian (LV) vessels during the reporting tick."@en ;
    skos:broader indo:fish-catch ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Mass .

indo:catch_sprat_SV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Total sprat catch, Swedish fleet (all vessels)"@en ;
    skos:prefLabel "Total sprat catch, Swedish fleet (all vessels)"@en ;
    skos:altLabel "catch_sprat_SV_All"@en ;
    skos:notation "catch_sprat_SV_All" ;
    skos:definition "Total mass of sprat caught by all Swedish (SV) vessels during the reporting tick."@en ;
    skos:broader indo:fish-catch ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Mass .

indo:catch_sprat_LV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Total sprat catch, Latvian fleet (all vessels)"@en ;
    skos:prefLabel "Total sprat catch, Latvian fleet (all vessels)"@en ;
    skos:altLabel "catch_sprat_LV_All"@en ;
    skos:notation "catch_sprat_LV_All" ;
    skos:definition "Total mass of sprat caught by all Latvian (LV) vessels during the reporting tick."@en ;
    skos:broader indo:fish-catch ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Mass .

indo:VA_SV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Value added, Swedish fleet (all vessels)"@en ;
    skos:prefLabel "Value added, Swedish fleet (all vessels)"@en ;
    skos:altLabel "VA_SV_All"@en ;
    skos:notation "VA_SV_All" ;
    skos:definition "Gross value added (landing revenue minus running costs) by all Swedish (SV) fishing vessels during the reporting tick."@en ;
    skos:broader indo:fleet-value-added ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .

indo:VA_LV_All a ind:Indicator, sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Value added, Latvian fleet (all vessels)"@en ;
    skos:prefLabel "Value added, Latvian fleet (all vessels)"@en ;
    skos:altLabel "VA_LV_All"@en ;
    skos:notation "VA_LV_All" ;
    skos:definition "Gross value added (landing revenue minus running costs) by all Latvian (LV) fishing vessels during the reporting tick."@en ;
    skos:broader indo:fleet-value-added ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Currency .
...
indo:SV_herring_market a sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Swedish herring market state"@en ;
    skos:prefLabel "Swedish herring market state"@en ;
    skos:altLabel "SV_herring_market"@en ;
    skos:notation "SV_herring_market" ;
    skos:definition "Categorical state of the Swedish (SV) herring market (e.g. human-consumption open, fish-meal only) governing which price applies to landings."@en ;
...
indo:SV_fishing_radius a sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Swedish vessel fishing radius"@en ;
    skos:prefLabel "Swedish vessel fishing radius"@en ;
    skos:altLabel "SV_fishing_radius"@en ;
    skos:notation "SV_fishing_radius" ;
    skos:definition "Maximum operational radius from home port within which Swedish (SV) vessel agents search for and exploit fishing patches."@en ;
    skos:broader indo:fleet-fishing-radius ;
    skos:inScheme ind:indicators-scheme ;
    qudt:hasQuantityKind quantitykind:Length .

indo:TAC_herring_inc_SV a sosa:ObservableProperty, skos:Concept ;
    rdfs:label "Swedish herring TAC increment"@en ;
    skos:prefLabel "Swedish herring TAC increment"@en ;
    skos:altLabel "TAC_herring_inc_SV"@en ;
    skos:notation "TAC_herring_inc_SV" ;
    skos:definition "Per-period adjustment (increment or decrement) applied to the Swedish (SV) herring TAC under the management rule, capturing year-to-year change in allowable catch."@en ;
...
* [SEADOTS Indicator Vocabulary](https://id3.seadots.eu/indicator/)
