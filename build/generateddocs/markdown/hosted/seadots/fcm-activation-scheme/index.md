...
# FCM activation and inference scheme (Model)

`ogc.hosted.seadots.fcm-activation-scheme` *v0.1*
...
* [FuzzyCognitiveMapTools.jl v0.1.0 -- activation_functions.jl, proc_trials.jl](https://gitlab.sintef.no/seadots-eu-project/tools/fuzzycognitivemaptools.jl)
* [FCMpy: a python module for constructing and analyzing fuzzy cognitive maps](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9575875/)
...
* Path: `_sources/_staging/fcm-activation-scheme`
