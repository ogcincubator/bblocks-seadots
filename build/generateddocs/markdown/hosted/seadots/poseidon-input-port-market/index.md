...
# POSEIDON Port and Market Input (Schema)

`ogc.hosted.seadots.poseidon-input-port-market` *v0.1*

Schema for port locations, market, price, fuel/gas-price, and landing infrastructure inputs consumed by POSEIDON.
...
```json
{
  ...
  "market": {
    "type": "Fixed Price Market",
    "priceBySpecies": {
      "Species_0": 10
    }
  },
  "fuel": {
    "gasPriceMaker": "Fixed Gas Price",
    "fuelPrice": 1.2
  }
}
...
```jsonld
{
  "@context": "https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-port-market/context.jsonld",
  "portInitializerType": "One Port",
  "ports": [
    {
      "name": "Main Port",
...
[] schema:location ( [ schema:name "Main Port" ;
                :usingGridCoordinates true ;
                :x 40 ;
                :y 25 ] ) ;
    schema:offers [ :priceBySpecies [ :Species_0 10 ] ;
            :type "Fixed Price Market" ] ;
    :fuel [ :fuelPrice 1.2e+00 ;
            :gasPriceMaker "Fixed Gas Price" ] ;
    :portInitializerType "One Port" .
...
title: POSEIDON Port and Market Input
description: Port, landing, market, and fuel-price input consumed by POSEIDON.
type: object
properties:
  portInitializerType:
    type: string
  ...
  ports:
    ...
    items:
      ...
      properties:
        ...
        longitude:
          type: number
          x-jsonld-id: https://schema.org/longitude
        latitude:
          type: number
          x-jsonld-id: https://schema.org/latitude
        usingGridCoordinates:
          type: boolean
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-port-market/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-port-market/schema.yaml)
...
[context.jsonld](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/poseidon-input-port-market/context.jsonld)

## Sources

* [POSEIDON PortInitializer YAML samples](https://github.com/poseidon-fisheries/POSEIDON/blob/main/POSEIDON/inputs/YAML%20Samples/components/PortInitializer.yaml)
...
* Path: `_sources/_stage/poseidon-input-port-market`
