...
# Reef Effect Output (Schema)

`ogc.hosted.seadots.reef-effect-output` *v0.2*
...
```json
{
  "id": "https://example.org/norwegian-ses/reef-effect-output/reef-biomass-result",
  "type": "Feature",
  "geometry": {
    "type": "Polygon",
    "coordinates": [[
  ...
  "properties": {
    ...
    "experimentOutput": {
      ...
      "vocabularyTerm": "https://w3id.org/indicators/marine/obs/floating-wind-reef-biomass-effect",
      "experiment": "https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1",
      "observedProperty": "https://w3id.org/indicators/marine/obs/floating-wind-reef-biomass-effect",
      ...
      "data": {
        ...
        "provenance": {
          ...
          "computeCodeNote": "Standalone Python script. Loads the six per-class input records, evaluates the equation at t=24 mo, propagates uncertainty by log-linear CV, and emits this output. Run: `python3 _sources/reef-effect/scripts/utsira_reef_biomass.py --json` to regenerate this JSON.",
          ...
          "provRecord": {
            "id": "https://example.org/norwegian-ses/reef-effect-output/prov-record",
            "type": "prov:Entity",
            ...
            "derivedFrom": [
              "https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1",
              "https://w3id.org/ogc/hosted/seadots/equation-property-relationship/examples/reef-biomass-equation",
              "../../reef-effect/scripts/utsira_reef_biomass.py"
            ],
            "note": "Merged from the former standalone provenance example so the primary reef-biomass result carries its PROV-O provenance inline."
          }
        }
      }
    }
  ...
  "links": [
    { "rel": "describedby", "href": "bblocks://ogc.hosted.seadots.reef-effect-output", "type": "application/schema+json", "title": "Reef Effect Output bblock" },
    { "rel": "derivedFrom", "href": "https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1", "type": "application/json", "title": "Experiment record this output belongs to" },
    ...
    { "rel": "provenance", "href": "https://example.org/norwegian-ses/reef-effect-output/prov-record", "type": "application/ld+json", "title": "Embedded PROV-O provenance record" }
  ]
}
...
```jsonld
{
  "@context": "https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/reef-effect-output/context.jsonld",
  "id": "https://example.org/norwegian-ses/reef-effect-output/reef-biomass-result",
  "type": "Feature",
  "geometry": {
    "type": "Polygon",
  ...
  "links": [
    {
      "rel": "describedby",
      "href": "bblocks://ogc.hosted.seadots.reef-effect-output",
      "type": "application/schema+json",
      "title": "Reef Effect Output bblock"
    },
    {
      "rel": "derivedFrom",
      "href": "https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1",
    ...
    {
      "rel": "provenance",
      "href": "https://example.org/norwegian-ses/reef-effect-output/prov-record",
      "type": "application/ld+json",
      "title": "Embedded PROV-O provenance record"
    }
  ]
}
```
...
@prefix ns1: <https://w3id.org/ogc/hosted/seadots/reef-effect#> .
...
@prefix seadots: <https://w3id.org/ogc/hosted/seadots/reef-effect-output#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
@prefix sosa: <http://www.w3.org/ns/sosa/> .
@prefix w3ctime: <http://www.w3.org/2006/time#> .
@prefix xsd: <http://www.w3.org/2001/XMLSchema#> .

<https://example.org/norwegian-ses/reef-effect-output/reef-biomass-result> a geojson:Feature ;
    rdfs:seeAlso [ rdfs:label "Equation evaluated to produce this result" ;
        ...
        [ rdfs:label "Embedded PROV-O provenance record" ;
            dcterms:format "application/ld+json" ;
            ns2:relation <http://www.iana.org/assignments/relation/provenance> ;
            oa:hasTarget <https://example.org/norwegian-ses/reef-effect-output/prov-record> ],
        [ rdfs:label "Reef Effect Output bblock" ;
            dcterms:format "application/schema+json" ;
            ns2:relation <http://www.iana.org/assignments/relation/describedby> ;
            oa:hasTarget <bblocks://ogc.hosted.seadots.reef-effect-output> ],
        [ rdfs:label "Experiment record this output belongs to" ;
            dcterms:format "application/json" ;
            ns2:relation <http://www.iana.org/assignments/relation/derivedFrom> ;
            oa:hasTarget <https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1> ] ;
    ...
    geojson:properties [ a seadots:Dataset ;
            ...
            seadots:output [ dcterms:conformsTo sosa:Observation,
                    ...
                    qudt:unit "kg" ;
                    skos:exactMatch indo:floating-wind-reef-biomass-effect ;
                    ...
                    sosa:observedProperty indo:floating-wind-reef-biomass-effect ;
                    ...
                    ns1:experiment <https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1> ;
                    ...
                    seadots:data [ dcterms:temporal "2026-05-13",
                            ...
                            prov:wasDerivedFrom [ dcterms:date "2026-05-19" ;
                                    skos:note "Standalone Python script. Loads the six per-class input records, evaluates the equation at t=24 mo, propagates uncertainty by log-linear CV, and emits this output. Run: `python3 _sources/reef-effect/scripts/utsira_reef_biomass.py --json` to regenerate this JSON.",
                                    ...
                                    prov:has_provenance <https://example.org/norwegian-ses/reef-effect-output/prov-record> ;
                                    prov:wasDerivedFrom <https://example.org/norwegian-ses/area-of-interest/utsira-surroundings>,
                                        ...
                                        <https://example.org/norwegian-ses/floating-wind-infrastructure/utsira-nord-60x15mw>,
                                        <https://example.org/norwegian-ses/reef-aggregation-index/degraer2020-bindings> ;
                                    seadots:computeCode <file:///reef-effect/scripts/utsira_reef_biomass.py> ;
                            ...
                            seadots:uncertainty [ dcterms:methodology "log-linear CV propagation" ;
                                    ...
                                    seadots:uncertaintyInput [ dcterms:source "imr_baseline_density_fallback.json:data.perTaxon[1].uncertainty_kg_m2",
                                    ...
                                    seadots:varianceAttribution [ skos:notation "S = Σᵢ Dᵢ·AFᵢ" ;
...
<https://example.org/norwegian-ses/reef-effect-output/prov-record> a prov:Entity ;
    ...
    skos:note "Merged from the former standalone provenance example so the primary reef-biomass result carries its PROV-O provenance inline." ;
    prov:wasDerivedFrom <file:///reef-effect/scripts/utsira_reef_biomass.py>,
        <https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1>,
        <https://w3id.org/ogc/hosted/seadots/equation-property-relationship/examples/reef-biomass-equation> ;
    ns1:experiment <https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1> ;
...
```json
{
  "id": "https://example.org/norwegian-ses/reef-effect-output/stac-catalog",
  "type": "Feature",
  "geometry": null,
  "properties": {
    "type": "Catalog",
...
@prefix ns2: <https://w3id.org/ogc/hosted/seadots/reef-effect#> .
@prefix oa: <http://www.w3.org/ns/oa#> .
@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> .
@prefix rec: <https://www.opengis.net/def/ogc-api/records/> .
@prefix seadots: <https://w3id.org/ogc/hosted/seadots/reef-effect-output#> .
...
<https://example.org/norwegian-ses/reef-effect-output/stac-catalog> a geojson:Feature ;
    rdfs:seeAlso [ rdfs:label "Reef Effect Output bblock" ;
            dcterms:format "application/schema+json" ;
    ...
    geojson:properties [ a seadots:Catalog ;
            ...
            seadots:output [ dcterms:conformsTo <https://id3.seadots.eu/conventions/edito-output>,
                    ...
                    ns2:experiment <https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1> ;
...
* YAML version: [schema.yaml](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/reef-effect-output/schema.json)
* JSON version: [schema.json](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/reef-effect-output/schema.yaml)
...
{
  "@context": {
    "@vocab": "https://w3id.org/ogc/hosted/seadots/reef-effect-output#",
      ...
      "@context": {
        "experimentOutput": {
          "@context": {
            ...
            "experiment": {
              "@id": "https://w3id.org/ogc/hosted/seadots/reef-effect#experiment",
              "@type": "@id"
            },
            "observedProperty": {
...
[context.jsonld](https://ogcincubator.github.io/bblocks-seadots/build/annotated/hosted/seadots/reef-effect-output/context.jsonld)
...
* Path: `_sources/reef-effect-output`
