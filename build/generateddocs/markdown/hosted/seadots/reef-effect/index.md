...
@prefix seadots: <https://w3id.org/ogc/hosted/seadots/reef-effect#> .
@prefix skos: <http://www.w3.org/2004/02/skos/core#> .
@prefix xsd: <http://www.w3.org/2001/XMLSchema#> .

<https://example.org/norwegian-ses/reef-effect/utsira-reef-biomass-surroundings-v1> a geojson:Feature ;
    ...
    geojson:properties [ a seadots:SoftwareSourceCode ;
            ...
            dcat:keyword "Python",
                ...
                "reef-effect",
                "surroundings" ;
            seadots:experiment [ dcterms:purpose "Evaluate the reef-biomass equation B_reef = sum_i (A_sub . D_pre,i . AF_i . C_t) for the surroundings of Utsira island under the Norwegian SES scenario. Inputs are the six per-class input records cited below; outputs are the two reef-effect-output records cited below. The PROV-O provenance record is embedded in the structured result output." ;
                    ...
                    seadots:execution [ dcterms:language "python" ;
                            seadots:entrypoint "python3 _sources/reef-effect/scripts/utsira_reef_biomass.py" ;
                            seadots:languageVersion ">=3.9" ;
                            seadots:reproducibility [ prov:wasGeneratedBy "PROV-O record embedded in the structured result output" ;
                    ...
                    seadots:output <https://example.org/norwegian-ses/reef-effect-output/reef-biomass-result>,
                        <https://example.org/norwegian-ses/reef-effect-output/stac-catalog> ;
                    seadots:parameter [ dcterms:title "Months since installation",
                                "colonisation_months" ;
...
<https://example.org/norwegian-ses/area-of-interest/utsira-surroundings> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "AOI — surroundings of Utsira island" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" .

<https://example.org/norwegian-ses/benthic-biomass-density-imr/ices-iva-fallback> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "IMR benthic biomass baseline — fallback" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" ;
    seadots:equationBinding "D_{pre,i}" .

<https://example.org/norwegian-ses/benthic-biomass-density-mareano/norwegian-shelf> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "MAREANO benthic biomass density — primary baseline" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" ;
    seadots:equationBinding "D_{pre,i}" .

<https://example.org/norwegian-ses/colonisation-time-factor/default-sigmoid> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "Colonisation time factor" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" ;
    seadots:equationBinding "C_t" .

<https://example.org/norwegian-ses/floating-wind-infrastructure/utsira-nord-60x15mw> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "Submerged infrastructure layout — Utsira Nord 60 × 15 MW" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" ;
    seadots:equationBinding "A_{sub}" .

<https://example.org/norwegian-ses/reef-aggregation-index/degraer2020-bindings> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "Reef aggregation index bindings" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#input" ;
    seadots:equationBinding "AF_i" .

<https://example.org/norwegian-ses/reef-effect-output/reef-biomass-result> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "Reef-associated biomass — structured result" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#output" .

<https://example.org/norwegian-ses/reef-effect-output/stac-catalog> a <https://w3id.org/ogc/hosted/seadots/reef-effect#application/json> ;
    dcterms:title "STAC catalog for the run" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#output" .

<file:///github/scripts/utsira_reef_biomass.py> a <https://w3id.org/ogc/hosted/seadots/reef-effect#text/x-python> ;
    dcterms:title "Utsira reef-biomass calculator (Python script)" ;
    geojson:rel "https://w3id.org/ogc/hosted/seadots/reef-effect#application" .
...
description: 'OGC API Records profile for a computational experiment realising a documented
  model. Extends GeoDCAT-Records with an `reef-effect` sub-object that points to the
  executable code (`application`) that runs the experiment, the documented model (`modelledBy`),
  the evidence equation (`evidenceEquation`), and standalone per-class input and `reef-effect-output`
...
x-jsonld-prefixes:
  seadots: https://w3id.org/ogc/hosted/seadots/reef-effect#
...
{
  "@context": {
    "@vocab": "https://w3id.org/ogc/hosted/seadots/reef-effect#",
