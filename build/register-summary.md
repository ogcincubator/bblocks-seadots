...
Profile for Swedish Digital Twin simulation output rows keyed by Eurostat NUTS region indicators, with examples for the raw tabular artifact, a SensorThings Observation view, and a GeoParquet representation header.
