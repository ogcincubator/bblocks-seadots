...
| `submerged_area_total_m2` (aggregate) | `indp:submerged-infrastructure-area` (SeaDOTs indicator namespace; real concept, no NERC URI yet) |
...
| `submerged_area_total_km2` | needs-vocabulary | Same concept as `submerged_area_total_m2` (`indp:submerged-infrastructure-area`) in different units — currently distinct local term; consider QUDT unit-conversion approach |
